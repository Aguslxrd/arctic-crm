...
INSERT INTO cases (userId, authId, title, description_case, case_status)
VALUES
(1, 2, 'Problema con facturación', 'El cliente reporta un error en su última factura.', 'ABIERTO'),
(1, 2, 'Solicitud de cambio de dirección', 'El cliente desea actualizar su dirección de envío.', 'EN_PROGRESO'),
(1, 2, 'Consulta sobre producto', 'El cliente tiene preguntas sobre las especificaciones del producto XYZ.', 'ABIERTO'),
(1, 2, 'Reembolso pendiente', 'El cliente solicita información sobre el estado de su reembolso.', 'CERRADO'),
(1, 2, 'Problema técnico con la aplicación', 'La aplicación móvil se cierra inesperadamente al intentar realizar un pago.', 'EN_PROGRESO');
